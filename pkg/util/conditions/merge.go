...
func merge(conditions []localizedCondition, targetCondition v1beta1.ConditionType, options *mergeOptions) *v1beta1.Condition {
...
func (g conditionGroups) TrueGroup() *conditionGroup {
	return g.getByStatusAndSeverity(corev1.ConditionTrue, v1beta1.ConditionSeverityNone)
}
...
func (g conditionGroups) ErrorGroup() *conditionGroup {
	return g.getByStatusAndSeverity(corev1.ConditionFalse, v1beta1.ConditionSeverityError)
}
...
func (g conditionGroups) WarningGroup() *conditionGroup {
	return g.getByStatusAndSeverity(corev1.ConditionFalse, v1beta1.ConditionSeverityWarning)
}

func (g conditionGroups) getByStatusAndSeverity(status corev1.ConditionStatus, severity v1beta1.ConditionSeverity) *conditionGroup {
	if len(g) == 0 {
		return nil
	}
	for _, group := range g {
...
type conditionGroup struct {
	...
	severity   v1beta1.ConditionSeverity
...
func (g conditionGroup) mergePriority() int {
	...
	case corev1.ConditionFalse:
		switch g.severity {
		case v1beta1.ConditionSeverityError:
			return 0
		case v1beta1.ConditionSeverityWarning:
			return 1
		case v1beta1.ConditionSeverityInfo:
			return 2
		}
