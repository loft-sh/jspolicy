...
type PatchOperation struct {
	Before *policyv1beta1.Condition
	After  *policyv1beta1.Condition
...
type applyOptions struct {
	ownedConditions []policyv1beta1.ConditionType
	forceOverwrite  bool
}

func (o *applyOptions) isOwnedCondition(t policyv1beta1.ConditionType) bool {
...
func WithOwnedConditions(t ...policyv1beta1.ConditionType) ApplyOption {
